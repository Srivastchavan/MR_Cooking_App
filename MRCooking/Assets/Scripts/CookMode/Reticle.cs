...
public class Reticle : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (_reticleTransform)
        {
            ...
            _indicatorOriginalScale = _indicatorTransform.localScale;
            _originalRotation = _reticleTransform.localRotation;
            _indicatorRotation = _indicatorTransform.localRotation;
    ...
    public void SetPosition()
    {
        ...
        _indicatorTransform.localScale = _indicatorOriginalScale * _defaultDistance;

        // The rotation should just be the default.
        _reticleTransform.localRotation = _originalRotation;
        _indicatorTransform.localRotation = _indicatorRotation;
    }
    ...
    public void SetPosition(RaycastHit hit)
    {
        ...
        _indicatorTransform.position = hit.point
                                     + hit.normal * _surfaceReticleDistance;
        ...
        _indicatorTransform.localScale = _indicatorOriginalScale * hit.distance;
        ...
        _indicatorTransform.rotation = Quaternion.FromToRotation(Vector3.forward, hit.normal);
    }
}
